...
public interface OutboxRepository extends JpaRepository<OutboxEvent, Long> {
    ...
    /** Não publicados, em ordem de gravação. O {@link Pageable} limita o lote. */
    List<OutboxEvent> findByPublishedAtIsNullOrderByIdAsc(Pageable pageable);

    /**
     * Trava a linha para publicação. Serializa o poller agendado e o gatilho
     * pós-commit assíncrono: quem chega depois relê a linha já {@code published}
     * e desiste — sem duplicata no caminho feliz de uma instância.
     */
